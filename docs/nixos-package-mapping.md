...
| `openai-codex` | Home Manager package | In-repo package pinned to the official `v0.152.0` Linux release | Added |
...
| `openai-chatgpt-desktop` | Desktop user app | `openai-chatgpt-desktop-nix` packaging with the official Debian package pinned to `26.831.20005` | Added on supported x86_64 hosts |
...
| `t3code` / `t3` | Home Manager packages | In-repo packages pinned to upstream `v0.0.37` | Both added on supported x86_64 Linux hosts |
