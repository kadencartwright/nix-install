...
| `openai-chatgpt-desktop` | Desktop user app | `openai-chatgpt-desktop-nix` packaging with the official Debian package pinned to `26.901.51231` | Added on supported x86_64 hosts |
...
| `t3code` / `t3` | Home Manager packages | In-repo packages pinned to upstream `v0.0.40` | Both added on supported x86_64 Linux hosts |
