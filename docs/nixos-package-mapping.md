...
| `openai-codex` | Home Manager package | In-repo package pinned to the official `v0.154.0` Linux release | Added |
...
| `openai-chatgpt-desktop` | Desktop user app | `openai-chatgpt-desktop-nix` packaging with the official Debian package pinned to `26.903.71938` | Added on supported x86_64 hosts |
