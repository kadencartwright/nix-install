...
| `openai-codex` | Home Manager package | In-repo package pinned to the official `v0.153.0` Linux release | Added |
...
| `openai-chatgpt-desktop` | Desktop user app | `openai-chatgpt-desktop-nix` packaging with the official Debian package pinned to `26.901.20858` | Added on supported x86_64 hosts |
