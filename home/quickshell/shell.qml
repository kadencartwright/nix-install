...
ShellRoot {
    ...
    Variants {
        ...
        delegate: PanelWindow {
            ...
            Command { command:["sh","-c","wpctl get-volume @DEFAULT_AUDIO_SINK@ | awk '{printf \"%.0f%%\",$2*100}'"]; interval:1500; onOutputChanged: if(output)bar.volume=output }
            ...
            Rectangle {
                ...
                Rectangle {
                    ...
                    MouseArea { anchors.fill:parent; onClicked:bar.togglePopup("calendar",bar.width/2) }
                }
                Row {
                    id: rightModules
                        ...
                        Rectangle {
                            ...
                            Row { anchors.fill:parent; anchors.leftMargin:13; anchors.rightMargin:13; spacing:9
                                ...
                                Rectangle {
                                    ...
                                    MouseArea { anchors.fill:parent; onClicked:Quickshell.execDetached(["nmcli","radio","wifi",bar.networkName==="Offline"?"on":"off"]) }
                                }
                            }
                        }
                        Loader {
